 ...
 *
 * @param string $script_hook Script hook.
 * @example wpdtrt_dbth_remove_blocking_js( 'twentysixteen_javascript_detection' );
 * @example add_action( 'after_setup_theme', 'wpdtrt_move_blocking_js' );
 */
 ...
 * @example add_action( 'wp_enqueue_scripts', 'wpdtrt_js_all_to_footer' );
 */
 ...
 * @example add_action( 'wp_enqueue_scripts', 'wpdtrt_js_comments' );
 */
