...
= 0.2.15 =
* Distinguish between CIs when accessing release tag
...
* Update eslint
* Use TRAVIS_TAG in release name
* Fix casing of Composer dependency
* Update Composer dependencies

= 0.2.12 =
* Only delete temporary release directory after SFTP deployment

= 0.2.11 =
* Update Node dependencies
* Update Node version used by Travis to match local dev
* Update README
...
= 0.2.7 =
* Exclude source maps from releases, by changing to a devDependency
* Update README
