...
//require_once( dirname( dirname(__FILE__) ) . '/vendor/html5-dom-document-php-master/autoload.php');
 ...
 * @example add_filter( 'the_content', 'wpdtrt_content_sections' );
 * @since 3.0.0
 */

add_filter( 'the_content', 'wpdtrt_content_sections' );

function wpdtrt_content_sections($content) {
