 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme <%= nameFriendly %>
...
add_action( 'tgmpa_register', '<%= nameSafe %>_____register_required_plugins' );
 ...
 */
function <%= nameSafe %>_____register_required_plugins() {
	/*
